...
from test_module import run_screensaver


def attack(char_name: str, char_class: str) -> str:
    """Возвращает количество урона, в зависимости от выбранного персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает количество блокированного урона.
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит на экран тип персонажа, команды для тренировки атаки.
    И объявление окончания тренировки.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Возвращает нвзвание выбранного персонажа и его описание."""
    approve_choice: str = ''
    char_class: str = ''
